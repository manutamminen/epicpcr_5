...
dil100mine = ['BiolstdM100XDilBC10e4mine', 'WWBiolstdM100XDilBC10e4mine', 'WWM100XDilBC10e4mine']
dil100fluo = ['BiolstdM100XDilBC10e4fluo', 'WWBiolstdM100XDilBC10e4fluo', 'WWM100XDilBC10e4fluo']
dil10mine = ['BiolstdM10XDilBC10e4mine', 'WWBiolstdM10XDilBC10e4mine', 'WWM10XDilBC10e4mine']
dil10fluo = ['BiolstdM10XDilBC10e4fluo', 'WWBiolstdM10XDilBC10e4fluo', 'WWM10XDilBC10e4fluo']
...
rule draw_abundance_comparisons:
  ...
  params:
    {'Type' : 'bacteria',
     'Samples' : dil10mine + dil100mine + dil10fluo + dil10fluo,
...
rule draw_tanglegrams:
  input:
    ...
    euk_abunds="tables/18S_abunds.txt"
  output:
    "figures/dil10mine.png",
    "figures/dil10mine_normalised.png",
    "figures/dil100mine.png",
    "figures/dil100mine_normalised.png",
    "figures/dil10fluo.png",
    "figures/dil10fluo_normalised.png",
    "figures/dil100fluo.png",
    "figures/dil100fluo_normalised.png"
  params:
    {'Samples' : dil10mine,
     'Colors' : colors,
